...
public class waitTypes {
	...
	public void test() throws InterruptedException {
		...
		// saving the GUI element reference into a "username" variable of
		// WebElement type
		...
		username.sendKeys("enter email id here");

		// click on next button
		WebElement next = drv.findElement(By.id("next"));
		next.click();

		// entering password

		drv.findElement(By.id("Passwd")).sendKeys("enter password here");
